...
tight_layout()
savefig("_BR_DI_APD_APA_$(p[2])_$(p[4]).pdf")
close()
...
tight_layout()
savefig("_BR_BCL_DIM_$(p[2])_$(p[4]).pdf")
close()
...
axs[2].set_xlim([0.0,400.0])
tight_layout()
savefig("_BR_BCL_APA_APD_$(p[2])_$(p[4]).pdf")
close()
...
axs[2].set_xlim([0.0,400.0])
tight_layout()
savefig("_BR_BCL_ALE_$(p[2])_$(p[4]).pdf")
close()
...
axs[2].set_xlim([0.0,400.0])
tight_layout()
savefig("_BR_BCL_DLE_$(p[2])_$(p[4]).pdf")
close()
